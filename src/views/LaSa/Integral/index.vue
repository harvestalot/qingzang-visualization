<template>
  <div class="LASA-Integral">
    <div class="LASA-Integral-top">
      <div class="LASA-Integral-top-left">
        <Population ref="childPopulation" />
        <Economy ref="childEconomy" />
        <UrbanLand ref="childUrbanLand" />
      </div>
      <div class="LASA-Integral-top-map">
        <Map />
      </div>
      <div class="LASA-Integral-top-right">
        <Water ref="childWater" />
        <Forest ref="childForest" />
        <VegetationIndex ref="childVegetationIndex" />
      </div>
    </div>
    <div class="LASA-Integral-bottom">
